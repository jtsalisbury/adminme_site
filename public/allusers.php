...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		<ul class="nav menu">
			...
			<li class='active'><a href="allusers.php"><svg class="glyph stroked notepad "><use xlink:href="#stroked-notepad"/></svg> All Users</a></li>
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<table data-toggle="table" data-url="../generators/genallusers.php"  data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true">
						    <thead>
						    <tr>
						        <th data-field="steamid" data-sortable="true" >SteamID</th>
						        <th data-field="name" data-sortable="true">Name</th>
						        <th data-field="last_join"  data-sortable="true">Last Join</th>
										<th data-field="play_time" data-sortable="true">
											Play Time
										</th>
						    </tr>
						    </thead>
